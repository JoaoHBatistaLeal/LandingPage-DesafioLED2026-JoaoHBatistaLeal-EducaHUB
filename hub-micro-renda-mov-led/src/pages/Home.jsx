    ...
    <div className="w-full min-h-[calc(100vh-80px)] flex items-center justify-center py-20 pb-32 bg-[#FDFBF7]">
      <div className="max-w-4xl px-6 w-full flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-6">
            <p className="text-[18px] md:text-[22px] text-[#0A1128]/80 font-medium leading-[1.6]">
              A transição para o Ensino Médio falha por dois motivos: a urgência de ajudar na renda de casa e a falta de interesse num ensino distante da realidade.
            </p>
            <p className="text-[18px] md:text-[22px] text-[#0A1128]/80 font-medium leading-[1.6]">
              O crime organizado é o maior concorrente da escola, oferecendo pertencimento e dinheiro rápido. A promessa de futuro pelos estudos não compete com a urgência do bolso vazio hoje.
            </p>
            ...
            <div className="border-l-8 border-[#C6EDDF] pl-6 py-2 mt-4 inline-block">
              <p className="text-[20px] md:text-[26px] font-extrabold text-[#0A1128] leading-[1.4] tracking-tight">
                A solução: o <span className="text-[#0A1128]">Hub de Micro-Renda</span> no contraturno.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8 flex-wrap">
          ...
          >
            Saiba mais <ArrowRight size={18} strokeWidth={3} />
          </motion.button>
        </div>
